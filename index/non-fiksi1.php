...
function readNonFiksiBooks($conn) {
    $sql = "SELECT * FROM books WHERE category='Non-Fiksi'";
    $result = $conn->query($sql);
    return $result->fetch_all(MYSQLI_ASSOC);
}

$fiksi_books = readNonFiksiBooks($conn);
?>
...
<head>
    ...
    <title>Kategori Non Fiksi - Perpustakaan Bersama</title>
